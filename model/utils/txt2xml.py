...
img_path = '../dataset/VisDrone_part/init/images'  # 图片文件夹
labels_path = '../dataset/VisDrone_part/init/labels'  # txt文件夹
annotations_path = '../dataset/VisDrone_part/init/Annotations'  # xml存放的文件夹
